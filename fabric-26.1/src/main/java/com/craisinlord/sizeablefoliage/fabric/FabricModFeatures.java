...
public final class FabricModFeatures {
    ...
    public static final BigSweetBerryBushWorldgenFeature BIG_SWEET_BERRY_BUSH = register("big_sweet_berry_bush", ModFeatures.createBigSweetBerryBushFeature());
    ...
    private static <T extends Feature<?>> T register(String path, T feature) {
        return Registry.register(BuiltInRegistries.FEATURE, Identifier.fromNamespaceAndPath(Constants.MOD_ID, path), feature);
    }
}
